...
1. How would you describe accessibility on the web to someone new to programming? ——Web accessibility means that websites, tools, and technologies are designed and developed so that people with disabilities can use them
2. Talk about 3 different things you can do to ensure your website is accessible.—-Viewport meta tag, alt tag descriptions,
   Media queries
3. How would you explain the concept of a variable to someone new to programming? —-are used to store information to be referenced and manipulated in a computer program
