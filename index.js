...
console.log(
  addArtist(
    ...
    "Reggae/dancehall",
    "German",
    "Raised traveling the world. living the nomad life, No official training. was a painter, printmaker, and theorist of the German Renaissance. Born in Nuremberg, Dürer established his reputation and influence across Europe when he was still in his twenties due to his high-quality woodcut prints."
  )
);
...
function randomize(array) {
  ...
  for (let i = array.length - 1; i > 0; i--) {
    randomPick = math.floor(math.random() * (1 + 1));
  }
  return randomPick;
}
console.log(randomPick.random());
